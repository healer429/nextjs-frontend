    ...
    render() {
        ...
        const handleSubmit = e => {
            ...
            if (form.checkValidity() === false) {
                ...
                this.props.orderEINCCorpStandardProduct(productInfo, this.props.history);
            }
...
export default _withFormWrapper(connect(mapStateToProps, mapDispatchToProps)(withRouter(EINCCorp)))