...
class EINChurch extends Component {
    state = {
        organizedState: "",
        legalName: null,
        dbaname: null,
    ...
    render() {
        ...
        const handleSubmit = e => {
            ...
            if (form.checkValidity() === false) {
                ...
                this.props.orderEINChurchStandardProduct(productInfo, this.props.history);
            }
                ...
                <Col sm={12}>
                    <Form noValidate validated={this.state.validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="dbaname">
                            <Form.Label>Trade name or DBA of the Church</Form.Label>
                        ...
                        <hr/>
                        <GeneralQuestions onChange={this.handleChange} state={this.state} applyBeforeLabel="Has this church ever received or applied for an EIN before?"/>
                        <hr/>
...
const mapDispatchToProps = dispatch => {
    return {
        orderEINChurchStandardProduct: (productInfo, history) => {
            dispatch(actionCreater.churchEinOrder(productInfo, history));
        },
        getProducts: () => {
...
export default _withFormWrapper(connect(mapStateToProps, mapDispatchToProps)(withRouter(EINChurch)))