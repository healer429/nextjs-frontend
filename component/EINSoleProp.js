    ...
    render() {
        ...
        const handleSubmit = e => {
            ...
            if (form.checkValidity() === false) {
                ...
                this.props.orderEINSolePropStandardProduct(productInfo, this.props.history);
            }
            ...
            <Container fluid className="Form">
                ...
                <Col sm={12}>
                    <Form noValidate validated={this.state.validated} onSubmit={handleSubmit}>
                        ...
                        <hr/>
                        <GeneralQuestions onChange={this.handleChange} state={this.state} applyBeforeLabel="Has this proprietorship ever received or applied for an EIN before?"/>
                        <hr/>
...
export default _withFormWrapper(connect(mapStateToProps, mapDispatchToProps)(withRouter(EINSoleProp)))