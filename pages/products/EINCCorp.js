...
class EINCCorp extends Component {
  state = {
    organizedState: "",
    legalName: null,
    dbaname: null,
  ...
  render() {
    ...
    const product = products.filter((u) =>
      u.code.replace("_", "").includes(this.props.router.pathname.substring(10))
    )[0];
    const handleSubmit = (e) => {
      ...
      if (form.checkValidity() === false) {
        ...
        this.props.orderEINCCorpStandardProduct(productInfo, this.props.router);
      }
    ...
    return (
      <Container fluid className="Form">
        ...
        <h3>2021 Corporations Tax ID / SS-4 Form</h3>
        <Col sm={12}>
          <Form
            noValidate
          ...
          >
            ...
            <Form.Group controlId="legalName">
              <Form.Label>Name of the Corporation</Form.Label>
              <Form.Control
                type="text"
                required
                placeholder="Name"
            ...
            <Form.Group controlId="dbaname">
              <Form.Label>DBA (Doing Business As)</Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Group controlId="organizedState">
              ...
              <RegionDropdown
                ...
                value={this.state.organizedState}
                valueType="short"
            ...
            <Form.Group controlId="principalOfficerTitle">
              ...
              <Form.Control required as="select" onChange={this.handleChange}>
                ...
                <option value="managing member/owner">
            ...
            <GeneralQuestions
              onChange={this.handleChange}
              state={this.state}
              applyBeforeLabel="Has this corporation ever received or applied for an EIN before?"
            />
            <hr />
            <CorporateAddress
              header="Corporate Address (PO Boxes are not authorized)"
              id="corpAddress"
              state={this.state}
              onChange={this.handleChange}
            />
...
const mapDispatchToProps = (dispatch) => {
  return {
    orderEINCCorpStandardProduct: (productInfo, history) => {
      dispatch(actionCreater.cCorpEinOrder(productInfo, history));
    },
    getProducts: () => {
...
export default _withFormWrapper(
  connect(mapStateToProps, mapDispatchToProps)(withRouter(EINCCorp))
);
