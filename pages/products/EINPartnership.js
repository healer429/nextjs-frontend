...
class EINPartnership extends Component {
    state = {
        organizedState: null,
        legalName: null,
        dbaname: null,
        primaryPartnerFirstName: null,
        primaryPartnerMiddleName: null,
        primaryPartnerLastName: null,
        primaryPartnerSSN: null,
        primaryPartnerSuffixName: null,
        primaryPartnerTitle: null,
    ...
    render() {
        ...
        return (
            <Container fluid className="Form">
                ...
                <h3>2021 Partnerships Tax ID / SS-4 Form</h3>
                <Col sm={12}>
                    <Form noValidate validated={this.state.validated} onSubmit={handleSubmit}>
                        <h5>Legal information</h5>

                        <Form.Group controlId="legalName">
                            <Form.Label>Name of the Partnership</Form.Label>
                            <Form.Control type="text" required placeholder="Name" onChange={this.handleChange}/>
                            <Form.Control.Feedback type="invalid">
                                Please enter the name of the partnership
                            </Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group controlId="dbaname">
                            <Form.Label>DBA of the Partnership</Form.Label>
                            <Form.Control type="text" placeholder="Optional" onChange={this.handleChange}/>
                        </Form.Group>
                        <hr/>
                        <h5>Primary Partner information</h5>
                        <Names id="primaryPartner" onChange={this.handleChange}/>
                        <Form.Group controlId="primaryPartnerSuffixName">
                        ...
                        <Form.Group controlId="primaryPartnerTitle">
                        ...
                        <SSN id="primaryPartner" state={this.state}
                             onChange={this.handleChange} />
                        <hr/>
                        <ActivityInputs onChange={this.handleChange} />
                        <hr/>
                        <GeneralQuestions onChange={this.handleChange} state={this.state} applyBeforeLabel="Has this partnership ever received or applied for an EIN before?"/>
                        <hr/>
...
const mapDispatchToProps = dispatch => {
    return {
        orderEINPartnershipStandardProduct: (productInfo, history) => {
            dispatch(actionCreater.partnershipEinOrder(productInfo, history));
        },
        getProducts: () => {
...
export default _withFormWrapper(connect(mapStateToProps, mapDispatchToProps)(withRouter(EINPartnership)))