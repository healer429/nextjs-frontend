...
class EINSoleProp extends Component {
  state = {
    dbaname: null,
    ownerFirstName: null,
  ...
  render() {
    ...
    const handleSubmit = (e) => {
      ...
      if (form.checkValidity() === false) {
        ...
        this.props.orderEINSolePropStandardProduct(
          productInfo,
          this.props.router
        );
      }
    ...
    return (
      <Container fluid className="Form">
        ...
        <h3>2021 Sole Proprietor Tax ID / SS-4 Form</h3>
        <Col sm={12}>
          <Form
            noValidate
          ...
          >
            ...
            <SSN id="owner" state={this.state} onChange={this.handleChange} />
            <hr />
            ...
            <GeneralQuestions
              ...
              state={this.state}
              applyBeforeLabel="Has this proprietorship ever received or applied for an EIN before?"
            />
            <hr />
            <CorporateAddress
...
const mapDispatchToProps = (dispatch) => {
  return {
    orderEINSolePropStandardProduct: (productInfo, history) => {
      dispatch(actionCreater.solePropEinOrder(productInfo, history));
    },
    getProducts: () => {
...
export default _withFormWrapper(
  connect(mapStateToProps, mapDispatchToProps)(withRouter(EINSoleProp))
);
